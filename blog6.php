...
<body>
	<?php 
		...
		<div class="col-12" style=""> <!-- 2. выводите все элементы в этом диве -->		
			 <?php 
				echo "<img class='w-100' src=' ".$database[5]["img"]." '>";
				echo "<h2 style='margin-bottom:-3px;' class='text-center'> " . $database[5]["title"] . "</h2>";
				echo "<p style='margin-bottom:5px;' class='text-center'>Автор: ".$database[5]["users"] ."</p>";
				echo "<p class='text-center p pb-5'>" . $database[5]["long_text"] . "</p>";
			 ?>
		</div>
	</div>
</body>
